...
def preprocess_images(images):
    ...
    images = np.repeat(images[:, :, :, np.newaxis], 3, axis=-1)  # Convert grayscale to RGB
    return images
...
# Step 3: Define and Train the Static Image-Based Model
model = Sequential([
...
with open("model_Task1_.json", "w") as json_file:
